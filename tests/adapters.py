...
def run_embedding(
    ...
    embed_layer.load_state_dict({'embed_mat':weights})
...
def run_multihead_self_attention_with_rope(
    ...
    Returns:
        ...
        implementation with the given QKV projection weights and input features.
    """
    from cs336_basics.nn import MultiheadSelfAttentionWithRoPE
...
def run_transformer_block(
    ...
    transformer_block.load_state_dict({
        ...
        'attn.o_weight.w' : weights['attn.output_proj.weight'],
...
def run_gradient_clipping(parameters: Iterable[torch.nn.Parameter], max_l2_norm: float) -> None:
    ...
    """
    from cs336_basics.nn import clip_gradient
...
def run_get_lr_cosine_schedule(
    ...
    """
    from cs336_basics.nn import cosine_lr_schedule
